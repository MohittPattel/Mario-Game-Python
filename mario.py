import pygame  #import the python module
import sys
pygame.init()  #initialzie the Init funtion 

WINDOW_WIDTH = 1200 #width of the game screen
WINDOW_HEIGHT = 600  #height of the game screen
FPS = 20
BLACK = (0, 0, 0)
GREEN = (0, 255, 0)
